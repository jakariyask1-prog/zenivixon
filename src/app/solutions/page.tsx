        ...
        <div className="space-y-16">
          {SOLUTIONS_DATA.map((solution, idx) => (
            <div
              key={solution.slug}
              id={solution.slug}
              className="rounded-3xl bg-white border border-slate-200 p-8 sm:p-12 shadow-sm transition-all hover:border-slate-300 hover:shadow-lg relative overflow-hidden"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-5 space-y-6">
                  ...
                  <div>
                    <span className="text-xs font-heading text-slate-500 font-bold uppercase">
                      PILLAR 0{idx + 1}
                    </span>
                ...
                <div className="lg:col-span-7 bg-slate-50/70 rounded-2xl p-6 sm:p-8 border border-slate-200/80 space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    {solution.features.map((feature, fIdx) => (
                      <div
                        key={fIdx}
                        className="p-4 rounded-xl bg-white border border-slate-200/80 shadow-xs space-y-2"
                      >
                  ...
                  <div className="pt-4 border-t border-slate-200">
                    <span className="text-xs font-heading text-slate-500 uppercase tracking-widest font-semibold">
                      Ideal for:
                    </span>
