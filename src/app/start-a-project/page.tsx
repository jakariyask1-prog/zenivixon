      ...
      <div className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-1.5">
            ...
            <h4 className="text-xs font-bold text-[#0F172A]">Submit Project Brief</h4>
            <p className="text-xs text-slate-500">Describe the problem and current tools.</p>
          </div>
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-1.5">
            <span className="text-xs font-heading text-cyan-600 font-bold">STAGE 02</span>
            <h4 className="text-xs font-bold text-[#0F172A]">Technical Audit</h4>
            <p className="text-xs text-slate-500">ZENIVIXON reviews workflow feasibility.</p>
          </div>
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-1.5">
            <span className="text-xs font-heading text-indigo-600 font-bold">STAGE 03</span>
            <h4 className="text-xs font-bold text-[#0F172A]">Architecture Proposal</h4>
            <p className="text-xs text-slate-500">Clear roadmap, deliverables, and timeline.</p>
          </div>
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-1.5">
            <span className="text-xs font-heading text-emerald-600 font-bold">STAGE 04</span>
            <h4 className="text-xs font-bold text-[#0F172A]">Engineering Kickoff</h4>
            <p className="text-xs text-slate-500">Sandbox build, validation, and live deploy.</p>
          </div>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-white border border-slate-200 max-w-xl mx-auto flex items-center justify-between gap-4 text-xs text-slate-600 shadow-sm">
