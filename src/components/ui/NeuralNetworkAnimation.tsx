...
export function NeuralNetworkAnimation() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // Draw connections
      ctx.lineWidth = 0.70; // User requested exact thickness
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none flex items-center justify-center opacity-80">
